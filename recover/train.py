...
from recover.models.models import GiantGraphGCN, Baseline, Dummy
from recover.models.message_conv_layers import ThreeMessageConvLayer, ProtDrugMessageConvLayer, \
    DummyMessageConvLayer
import os
from recover.models.predictors import InnerProductPredictor, MLPPredictor, FilmMLPPredictor, SharedLayersMLPPredictor, \
    ConcentrationOnlyPredictor
from recover.utils import get_project_root
from torch.utils.data import TensorDataset, DataLoader
from recover.models.acquisition import RandomAcquisition, ExpectedImprovement, GPUCB, Thompson, GaussianThompson, \
    GreedyAcquisition
...
if __name__ == '__main__':
    ...
    pipeline_config = {
        ...
        "weight_decay": 1e-5,
        "batch_size": 32,  # tune.grid_search([1024, 2048]),
    }

    predictor_config = {
        "predictor": MLPPredictor,
        "predictor_layers": [256, 1],
    ...
    model_config = {
        ...
        "model": Baseline,  # tune.grid_search([MLPBaselineFPExpr, MLPBaselineFPProt]),
