...
class DrugCombScore(InMemoryDataset):
    def __init__(self, transform=None, pre_transform=None, fp_bits=1024, fp_radius=4, ppi_confidence_thres=0):
        """
        Dataset object for the drugcomb dataset. The drug scores are retrieved from https://drugcomb.fimm.fi
...
if __name__ == '__main__':
    ...
    dataset = DrugCombScoreNoPPI(fp_bits=1024, fp_radius=4)
