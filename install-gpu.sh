...
conda install -y pytorch::pytorch pytorch::torchvision cudatoolkit=10.1 tensorflow-gpu pandas conda-forge::rdkit networkx scikit-image scikit-learn numba isodate jsonschema redis-py pyyaml colorama filelock aiohttp beautifulsoup4 future lz4 tabulate fastparquet
