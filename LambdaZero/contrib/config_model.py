...
from LambdaZero.model_with_uncertainty import MolMCDropGNNDeup, MolMCDropGNNDeupDebug
...
trainer_config = { # tune trainable config
    ...
    "logger_config": {
        "wandb": {
            "project": "model_with_uncertainty_deup",
...
model_deup_001 = {
    "tune_config":{
        "config": {"model":MolMCDropGNNDeup,
                   "model_config": {"log_epoch_metrics":True,
                                    "train_epochs":5
                                    }}
}}

model_deup_debug_001 = {
    "tune_config":{
        "config": {"model":MolMCDropGNNDeupDebug,
                   "model_config": {"log_epoch_metrics":True,
                                    "train_epochs":2
                                    }}
}}