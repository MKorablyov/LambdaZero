...
import train_boltzmann_config
from train_boltzmann_config import DEFAULT_CONFIG

datasets_dir, programs_dir, summaries_dir = LambdaZero.utils.get_external_dirs()

if len(sys.argv) >= 2: config_name = sys.argv[1]
else: config_name = "boltzmann_config_001"
config = getattr(train_boltzmann_config, config_name)
