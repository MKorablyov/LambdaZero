...
class MPNNet_v2(nn.Module):
    def __init__(self, num_feat=14, num_vec=3, dim=64, num_out_per_mol=1,
    ...
    def forward(self, data, vec_data):
...
class MolAC_GCN(nn.Module):
    def __init__(self, nhid, nvec, num_blocks, num_out_per_mol):
