...
from diversityenv import DiversityEnv
...
if __name__ == "__main__":
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if t < args.start_timesteps:
            action = np.random.default_rng().uniform(-1.0, 1.0, 4)
        ...
        replay_buffer.add(state.squeeze(1), action, next_state.squeeze(1), reward, done_bool)
