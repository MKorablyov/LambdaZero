...
class Actor(nn.Module):
    def __init__(self, particle_size, horizon, action_dim, max_action):
        super(Actor, self).__init__()

        self.time_embedding = nn.Linear(horizon, 256)
        self.particle_embedding = nn.Linear(particle_size, 256)
