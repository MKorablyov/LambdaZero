...
from LambdaZero.examples.bayesian_models.bayes_tune.botorch_utils import _flip_sub_unique
from botorch.models.model import Model
from botorch.sampling.samplers import IIDNormalSampler
from LambdaZero.examples.bayesian_models.bayes_tune.botorch_utils import batched_multinomial
...
class BoltzmannSampling(SamplingStrategy):
    ...
    def forward(self, X: Tensor, num_samples: int = 1, **kwargs: Any) -> Tuple[torch.Tensor, torch.Tensor]:
