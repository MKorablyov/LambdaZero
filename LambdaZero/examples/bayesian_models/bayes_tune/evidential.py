...
from LambdaZero.examples.bayesian_models.bayes_tune.functions import evidential_train_epoch, evidential_eval_epoch, \
    train_evidential, evidential_mean_variance 
...
class EvidentialRegression(tune.Trainable):
    ...
    def fit(self, train_loader, val_loader, validate=False):
        ...
        if validate:
            ...
            # TODO: add likelihood evaluation on val set
        else:
            return all_scores[-1], {}
...
data_config = {
    ...
    "dataset_split_path": osp.join('/scratch/mjain/',
    ...
    "dataset_config": {
        "root": osp.join('/scratch/mjain/', "brutal_dock/mpro_6lze"),
        "props": ["gridscore", "smi"],
        "transform": transform,
...
DEFAULT_CONFIG = {
    "regressor_config":{
        "run_or_experiment": EvidentialRegression,
        "config": {
            "data":data_config,
            "reg_coefficient": 1e-2,
            "uncertainty_eval_freq":15,
            "train_iterations":150,
            "model": LambdaZero.models.MPNNetDrop,
            "model_config": {"drop_data":False, "drop_weights":False, "drop_last":False, "drop_prob":0.0, "evidential": True},
            # "model_config": {},
            ...
            "train_epoch": evidential_train_epoch,
            "eval_epoch": evidential_eval_epoch,
...
if __name__ == "__main__":
    ...
    else: config_name = "evidential_001"
