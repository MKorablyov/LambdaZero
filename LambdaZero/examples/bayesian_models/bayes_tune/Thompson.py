...
#             "aq_top50":aq_top50,"aq_frac_top1_percent":frac_top1percent}
...
class Thompson(tune.Trainable):
    ...
    def acquire_batch(self, batch_size):
        idxs = []
        for _ in range(batch_size):
            ...
            idx = self.get_posterior_sample(X_in = ul_embs, X_trn = embs,
                                            y = y, idxs = idxs,
                                            X_feature_size = 64, sigma_y = 0.2)
