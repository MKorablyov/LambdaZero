...
class NewDrugComb(InMemoryDataset):
    ...
    def process(self):
        ...
        drug_nodes, protein_nodes, cid_to_idx_dict, name_to_idx_dict = self._get_nodes()
    ...
    def _get_nodes(self):
        ...
        return drug_nodes, protein_nodes, cid_to_idx_dict, name_to_idx_dict
...
if __name__ == '__main__':
    ...
    dataset = NewDrugComb(fp_bits=1024, fp_radius=4)
