...
if __name__ == '__main__':
    if not dataset_pickle_path.is_file():
        ...
        dataset_splitter = RandomDatasetSplitter(train_fraction=0.8,
        ...
        batchsize = 256
        training_dataloader = DataLoader(training_dataset, shuffle=True, batch_size=batchsize)
    ...
    cm, display_labels = get_truncated_confusion_matrix_and_labels(y_true=df['actual block'].values,
    ...
    ax = fig.add_subplot(111)
    ax.hist(angle_error/np.pi*180., bins=60)
