...
from LambdaZero.examples.env3d.dataset.parsing_parameter_inputs import extract_parameters_from_configuration_file, \
    get_output_filename
...
if __name__ == "__main__":
    ...
    for _ in range(num_cpus):
        ...
        g = DataRowGenerator.remote(blocks_file,
